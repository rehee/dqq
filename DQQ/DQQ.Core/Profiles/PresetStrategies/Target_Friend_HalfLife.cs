...
{
	[Pooled]
	internal class Target_Friend_HalfLife : PresetStrategyProfile
	{
		public override EnumPresetSkillStrategy ProfileNumber => EnumPresetSkillStrategy.Target_Friend_HalfLife;
