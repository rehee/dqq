...
{
	[Pooled]
	internal class Target_Enemy_LowLife : PresetStrategyProfile
	{
		public override EnumPresetSkillStrategy ProfileNumber => EnumPresetSkillStrategy.Target_Enemy_LowLife;
