...
namespace DQQ.Profiles.Durations
{
	public abstract class DurationProfile : DQQProfile<EnumDurationNumber>
	{
		...
		public virtual void Healing(ComponentTickParameter? parameter, DurationComponent compose, ITarget? target, IMap? map)
		{

		}

		public virtual void Damage(ComponentTickParameter? parameter, DurationComponent compose, ITarget? target, IMap? map)
		{

		}

		public virtual void OnActive(ComponentTickParameter? parameter, DurationComponent compose, ITarget? target, IMap? map)
		{
			Healing(parameter, compose, target, map);
			Damage(parameter, compose, target, map);
		}
