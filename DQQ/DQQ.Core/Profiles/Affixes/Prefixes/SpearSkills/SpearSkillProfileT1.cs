...
namespace DQQ.Profiles.Affixes.Prefixes.SpearSkills
{
  ...
  public class SpearSkillProfileT1 : SpearSkillProfile
  {
    ...
    public override EnumItemType[]? ItemTypeLimites => new[] { EnumItemType.Spear };
    public override EnumEquipType[]? EquipTypeLimites => new[] { EnumEquipType.TwoHandWeapon };
    public override AffixeRange[] Ranges => new[] { AffixeRange.New(EnumPropertyType.DamageModifier, 10) };
