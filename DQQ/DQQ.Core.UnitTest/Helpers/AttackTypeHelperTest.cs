...
namespace DQQ.Core.UnitTest.Helpers
{
	public class AttackTypeHelperTest : BaseTest
	{
		...
		{
			var chainTarget = AttackTypeHelper.GetChainTargets(Targets[0],
							Targets, 5);
			Assert.That(chainTarget.Count(), Is.EqualTo(5));
			chainTarget = AttackTypeHelper.GetChainTargets(Targets[0],
				Targets, 6);
		...
		{
			var chainTarget = AttackTypeHelper.GetAreaTargets(Targets[5],
							Targets, Enums.EnumAreaLevel.Self);
			Assert.That(chainTarget.Count(), Is.EqualTo(1));

			chainTarget = AttackTypeHelper.GetAreaTargets(Targets[5],
			...
			chainTarget = AttackTypeHelper.GetAreaTargets(Targets[4],
							Targets, Enums.EnumAreaLevel.TargetWithRadius2);
			Assert.That(chainTarget.Count(), Is.EqualTo(5));
			chainTarget = AttackTypeHelper.GetAreaTargets(Targets[4],
							Targets, Enums.EnumAreaLevel.TargetWithRadiusMax);
			Assert.That(chainTarget.Count(), Is.EqualTo(10));
			chainTarget = AttackTypeHelper.GetAreaTargets(Targets[0],
							Targets, Enums.EnumAreaLevel.TargetWithRadiusMax);
			Assert.That(chainTarget.Count(), Is.EqualTo(10));
		}
		[Test]
		...
		{
			var chainTarget = AttackTypeHelper.GetMultiAttackTargets(Targets[5],
							Targets, Enums.EnumAreaLevel.Self, 5);
			Assert.That(chainTarget.Count(), Is.EqualTo(5));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(5));


			chainTarget = AttackTypeHelper.GetMultiAttackTargets(Targets[5],
		...
		{
			var chainTarget = AttackTypeHelper.GetPiercingTargets(Targets[5],
							Targets, Enums.EnumAreaLevel.Self);
			Assert.That(chainTarget.Count(), Is.EqualTo(1));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));

			chainTarget = AttackTypeHelper.GetPiercingTargets(Targets[5],
							Targets, Enums.EnumAreaLevel.Single);
			Assert.That(chainTarget.Count(), Is.EqualTo(1));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));
			...
			Assert.That(chainTarget.Count(), Is.EqualTo(5));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));
			chainTarget = AttackTypeHelper.GetPiercingTargets(Targets[0],
							Targets, Enums.EnumAreaLevel.TargetWithRadiusMax);
			Assert.That(chainTarget.Count(), Is.EqualTo(10));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));
		}
		...
		{
			var chainTarget = AttackTypeHelper.GetCleaveTargets(Targets[5],
							Targets, Enums.EnumAreaLevel.Self);
			Assert.That(chainTarget.Count(), Is.EqualTo(1));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));

			chainTarget = AttackTypeHelper.GetCleaveTargets(Targets[5],
							Targets, Enums.EnumAreaLevel.Single);
			Assert.That(chainTarget.Count(), Is.EqualTo(1));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));
			...
			Assert.That(chainTarget.Count(), Is.EqualTo(6));
			Assert.That(chainTarget.Count(b => b.DisplayId == Targets[5].DisplayId), Is.EqualTo(1));
			chainTarget = AttackTypeHelper.GetCleaveTargets(Targets[0],
							Targets, Enums.EnumAreaLevel.TargetWithRadiusMax);
			Assert.That(chainTarget.Count(), Is.EqualTo(6));
